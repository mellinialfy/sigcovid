            ...
            <form method="post" action="/data/update/{{ $positif->id_positif }}">
                ...
                <div class="dragArea row">
                    <div class="col-md-6  form-group" >
                        ...
                        <input type="text" name="kabupaten" disabled="disabled" value=" {{ $positif->kabupaten->nama_kabupaten }}" required="required" class="form-control input display-7">
                    </div>
                    <div class="col-md-6  form-group" >
                    ...
                    <div class="col-md-12  form-group">
                        ...
                        <input type="text" name="dirawat" value=" {{ $positif->dirawat }}" class="form-control input display-7">
                    </div>
                    <div class="col-md-12 form-group">
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <input type="text" name="wna" value=" {{ $positif->wna }}" required="required" class="form-control input display-7">
                    </div>
                    <div class="col-md-12 form-group">
                        <label class="form-control-label mbr-fonts-style display-7">WNI</label>
                        <input type="text" name="wni" value=" {{ $positif->wni }}" required="required" class="form-control input display-7">
                    </div>
                    <div class="col-md-12 form-group">
                        <label class="form-control-label mbr-fonts-style display-7">Imported Case</label>
                        <input type="text" name="ic" value=" {{ $positif->ic }}" required="required" class="form-control input display-7" >
                    </div>
                    <div class="col-md-12 form-group">
